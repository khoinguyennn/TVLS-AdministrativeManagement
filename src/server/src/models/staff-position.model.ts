...
export type StaffPositionCreationAttributes = Optional<
  StaffPosition,
  'id' | 'jobPosition' | 'positionGroup' | 'recruitmentAgency' | 'professionWhenRecruited' | 'rankLevel' | 'educationLevel' | 'rankCode' | 'subjectGroup' | 'contractType'
>;
  ...
  StaffPositionModel.init(
    {
      ...
      rankLevel: { allowNull: true, type: DataTypes.STRING(100), field: 'rank_level' },
      educationLevel: { allowNull: true, type: DataTypes.STRING(100), field: 'education_level' },
      ...
      contractType: { allowNull: true, type: DataTypes.STRING(100), field: 'contract_type' },
    },
    {
